            ...
            <div class="row justify-content-md-center">
                <div class="col-lg-12 col-xs-12">
                    <div class="card card-default">
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form class="form-horizontal" action="{{ route('agents.save') }}" method="post">
                            @csrf
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-xs-12">
                                        ...
                                        <div class="form-group row">
                                            <label for="province_id" class="col-sm-2 col-form-label">Province / State</label>
                                            <div class="col-sm-9">
                            ...
                            <div class="card-footer">
                                ...
                                <a href="{{ URL::route('agents') }}" class="btn btn-danger float-right">Cancel</a>
                            </div>
                            <!-- /.card-footer -->
                        </form>
                    </div>
