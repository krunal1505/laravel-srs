            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="{{ URL::route('students.enrolled') }}">Enrolled Students</a></li>
                ...
                <div class="col-lg-12 col-xs-12">
                    <div class="card card-default">
                        <div class="card-header">
                            <h3 class="card-title">View Enrolled Student</h3>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form class="form-horizontal" action="{{ route('students.new.updateStatus') }}" method="post">
                            ...
                            <div class="card-footer">
                                <a href="{{ URL::route('students.enrolled') }}" class="btn btn-danger float-right">
